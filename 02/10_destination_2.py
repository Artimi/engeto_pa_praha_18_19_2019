...
if age < 15:
    print('Sorry we don\'t offer our services to persons younger than 15')
elif '@' not in email:
    print('Sorry, you have provided incorrect e-mail. There has to be @ symbol.')
